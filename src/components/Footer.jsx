...
const Footer = () => {
  return (
    <footer className="footer mt-auto bg-base-300 text-base-content p-10">
      <nav>
        <h6 className="footer-title">Legal</h6>
        <Link to="privacyPolicy" className="link link-hover">
          Privacy Policy
        </Link>
        <Link to="termsAndConditions" className="link link-hover">
          Terms & Conditions
        </Link>
        <Link to="cancelAndRefund" className="link link-hover">
